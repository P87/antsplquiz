  ...
  [804],
  {
    ...
    448: (e, t, n) => {
      ...
      function di(e) {
        ...
        if (
          ...
          if (
            ...
            throw ((t = Au), bi(e, 0), fi(e, n), ci(e, Ia()), t);
          switch (
      ...
      function mi(e) {
        ...
        if (
          ...
          throw ((n = Au), bi(e, 0), fi(e, t), ci(e, Ia()), n);
        return (
        ...
        switch (((t.lanes = 0), t.tag)) {
          ...
          case 4:
            return (
              Tl(t, t.stateNode.containerInfo),
              (r = t.pendingProps),
              null === e ? (t.child = kl(t, null, r, n)) : Lo(e, t, r, n),
              t.child
            );
          case 11:
            return (
    ...
    38: function (e, t, n) {
      ...
      t.default = () => {
        ...
        return (
          u.useEffect(() => {
            fetch(`/questions/get-correct-answers/${h}`, {
              method: "POST",
              headers: {
                Accept: "application/json",
                "Content-Type": "application/json",
            ...
            : u.default.createElement(
                ...
                a[0].answer_type === s.CORRECT_SCORE_TYPE &&
                  u.default.createElement(c.default, {
                    submitUrl: `/admin/questions/set-correct-text-answer/${h}`,
                    setErrorMessage: t,
                  }),
                ...
                a[0].answer_set_id === s.ALL_PLAYERS_TYPE &&
                  u.default.createElement(d.default, {
                    ...
                    setErrorMessage: t,
                    submitUrl: `/admin/questions/set-correct-players-answer/${h}`,
                  }),
                a[0].answer_set_id === s.ALL_TEAMS_TYPE &&
                  u.default.createElement(f.default, {
                    answerAmount: a[0].answer_amount,
                    setErrorMessage: t,
                    submitUrl: `/admin/questions/set-correct-teams-answer/${h}`,
                    setAnswers: o,
                  }),
                a[0].answer_set_id === s.ALL_MANAGERS_TYPE &&
                  u.default.createElement(p.default, {
                    ...
                    setErrorMessage: t,
                    setAnswers: o,
                    submitUrl: `/admin/questions/set-correct-managers-answer/${h}`,
                  })
              )
        );
      };
        ...
        return (
          u.useEffect(() => {
            ...
            fetch(`/admin/users/get/${e}`, {
              ...
              .then((e) => {
                e.success
                  ? (t(e.user[0]), s(e.questions), d(e.answers))
    ...
    388: function (e, t, n) {
      ...
      (t.AnswerForm = ({
        ...
        switch (e.answer_type) {
          ...
          case null:
            if (e.answer_set_id === p.ALL_TEAMS_TYPE && n)
            ...
            if (e.answer_set_id === p.ALL_PLAYERS_TYPE)
            ...
            if (e.answer_set_id === p.ALL_MANAGERS_TYPE)
              ...
              fetch(`/questions/get/${e}`, {
                ...
                .then((e) => {
                  e.success
                    ? (n(e.question),
                      c(e.setAnswers),
                      p(new Date(e.question.deadline)),
